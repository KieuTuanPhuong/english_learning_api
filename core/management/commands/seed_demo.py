    ...
    def handle(self, *args, **options):
        ...
        modules = [
            ...
            LearningModule.objects.create(
                ...
                band=BandLevel.BAND_5_6, topic=Topic.EDUCATION),
            LearningModule.objects.create(
                ...
                band=BandLevel.BAND_6_7, topic=Topic.EDUCATION),
            LearningModule.objects.create(
            ...
            LearningModule.objects.create(
                ...
                band=BandLevel.BAND_7_8, topic=Topic.WORK),
        ]
        ...
        exercises = [
            ...
            Exercise.objects.create(module=modules[0], title="Asking for directions",
                ...
                created_by=teachers[1],
                band=BandLevel.BAND_4_5, topic=Topic.TRAVEL),
            Exercise.objects.create(module=modules[0], title="Greetings quiz",
                ...
                created_by=teachers[1],
                band=BandLevel.BAND_5_6, topic=Topic.WORK),
